...
[1. When is the Democracy Earth private token sale?](#question-1)

[2. What is an accredited investor?](#question-2)

[3 Why is the token sale limited to accredited investors?](#question-3)

[4. Why does the token sale exclude accredited investors from NY and China?](#question-4)

[5. What cryptocurrencies will be accepted?](#question-5)

[6. Where can I receive updates?](#question-6)

[7. How can I talk to the founders or President?](#question-7)

[8. When will I receive my SAFT?](#question-8)
...
[10. Is the VOTE token a security?](#question-10)

[11. What will the token sale funds be used for?](#question-11)

[12. Why is the *vote* token a utilty token?](#question-12)

[13. Where does the Democracy Earth *vote* token get its value?](question-13)

[14. I bought tokens in the pre-sale with a 12 month lockup - when will I get my tokens?](#question-14)
...
Our ale is a [US SEC](https://en.wikipedia.org/wiki/U.S._Securities_and_Exchange_Commission)-regulated, Regulation D, Rule 506(b) security offering. We are offering (at various price levels, based on lockup) the *right* to tokens that will be available in the Democracy Earth token sale. Under this regulation, only accredited investors, [as defined by the SEC](https://www.sec.gov/files/ib_accreditedinvestors.pdf), are allowed to participate in the token sale. Democracy Earth partners with [CoinList](https://coinlist.co/help/what-is-an-accredited-investor) for investor accreditation verification for token sale participation. 

Investors can verify their accreditation status for the Demcoracy Earth token sale online at the [Democracy Earth CoinList portal.](https://complyapi.coinlist.co/democracy-earth).
...
<a name="question-4"></a>
**4 - Why does the sale exclude accredited investors from NY and China?**

In order to comply with SEC regulations only accredited investors may participate in the token sale, and only in jurisdictions the SEC does not ban. Click [here](https://coinlist.co/help/what-is-an-accredited-investor) to see CoinList criteria for accreditation verification. Chinese regulatory authorities prohibit Chinese citizens and companies from participating in token sales. 

<a name="question-5"></a>
**5 - What cryptocurrencies will be accepted in the Democracy Earth token pre-sale?**

We will accept BTC // BCH // ETH. The sale will be closed when 50M [token allotment](token.democracy.earth) has been purchased). Wire transfers are also acceptable.  

<a name="question-6"></a>
**6 - Where can I receive updates?**
...
<a name="question-7"></a>
**7 - How can I talk to the founders about my questions regarding Democracy Earth and the token sale?**
...
<a name="question-8"></a>
**8 - When will I receive my SAFT (Simple Agreement for Future Tokens)?**

A personal link to an executable SAFT (Simple Agreement for Future Tokens) will be sent to you by e-mail upon your registration for purchase and affirmation of accreditation on our website: https://token.democracy.earth.  Notify a DEF admin on [the Democracy Earth Telegram channel](https://t.me/democracyearthico) if you do not receive your SAFT. A review copy of the SAFT can be found [here](https://www.dropbox.com/s/cs5qbcmkxf3a5ge/SAFT%20-%20Democracy%20Earth%20Foundation.pdf?dl=0).  
...
<a name="question-9"></a>
**9 - How can _votes_ be crypto assets? Doesn’t that empower the rich to have more impact over decision-making processes?**
...
**10. Is the *vote* token a security?**
...
Democracy Earth is utlizing an industry standard Simple Agreement for Future Tokens (SAFT) which IS a security.  In order to comply with SEC regulations we can only sell this security to accredited investors, and only in jurisdictions the SEC does not ban (China and New York). 

<a name="question-11"></a>
**11. What will the token sale funds be used for?**
...
**12. Why is the vote token a 'utility token'?  Why not a 'security token'?**
...
**13. Where does the Democracy Earth *vote* token get its value?**
...
**14. I bought tokens in the pre-sale with a 12 month lockup - when will I get my tokens?**
